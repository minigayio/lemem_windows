...
run_system() {
  ...
  $DOCKER_RUN "qemu-system-x86_64 -m "4096" -smp $(nproc --all) -cpu EPYC-Milan -nic user,hostfwd=tcp::"25414"-:3389 -drive file=windows11.qcow2 -drive file=fat:rw:shared -usbdevice tablet -display vnc=127.0.0.1:1,password -monitor stdio < qemu_cmd.txt"                         
